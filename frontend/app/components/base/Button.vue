...
const buttonClass = computed(() => {
  ...
  const variantClass: Record<ButtonVariant, string> = {
    ...
    secondary: 'border-default/60 bg-elevated/85 text-muted normal-case tracking-wide shadow-[0_10px_24px_-20px_rgb(0_0_0_/_0.8)] focus-visible:ring-primary/35 hover:-translate-y-px hover:border-lavender/25 hover:bg-lavender/8 hover:text-highlighted',
